...
# This code adapted from  https://github.com/IShengFang/SpectralNormalizationKeras.
# (C) 2019 I-Sheng Fang, see LICENSE in this directory for license information.
...
# from tensorflow.keras.legacy import interfaces
from tensorflow.keras.layers import Dense, Conv1D, Conv2D, Conv3D, Conv2DTranspose, Embedding, Layer
...
class DenseSN(Dense):
    ...
    def call(self, inputs, training=None):
        ...
        if not training: # == 0 or training == False:
